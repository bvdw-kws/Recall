...
#include "RecallPlayerInputProcessors.generated.h"

UCLASS()
class URecallPlayerInputProcessor : public UMassProcessor
{
	GENERATED_BODY()
...
private:
	...
	TSharedPtr<struct FRecallPlayerInputCacheManager> CacheManager;
